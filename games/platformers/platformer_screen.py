...
class PlatformerScreen(Screen):
    ...
    def __init__(self):
        ...
        self.platforms = [Platform(), Platform(0, screen_height - 100, screen_length, 200, True),
                          Platform(Platform().right_edge + 200, Platform().y_coordinate, screen_height, screen_length, True)]
    ...
    def alter_player_horizontal_movement(self, left_collision_data, right_collision_data):
        ...
        if left_collision_data[0]:
            print("LEFT SIDE OF PLATFORM")

        if right_collision_data[0]:
            print("RIGHT SIDE OF PLATFORM")
